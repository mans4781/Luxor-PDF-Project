      ...
      <header className="border-b bg-white overflow-hidden" style={{ height: 64 }}>
        <div className="relative h-full w-full">
          ...
          >
            ...
            {/* All icons grouped — starts at x=650, scale 0.6, 130px spacing */}
            <g transform="translate(650,0) scale(0.6)">
              ...
              <circle cx="60" cy="53" r="5" fill="rgba(139,92,246,0.18)"/>
              <circle cx="74" cy="53" r="3.5" fill="rgba(139,92,246,0.12)"/>
              ...
              <circle cx="192" cy="53" r="5" fill="rgba(236,72,153,0.18)"/>
              <circle cx="206" cy="53" r="3.5" fill="rgba(236,72,153,0.12)"/>

              {/* PDF Doc amber — x=260 */}
              <g transform="translate(260,8)" filter="url(#docShadow2)">
              ...
              <circle cx="316" cy="53" r="5" fill="rgba(245,158,11,0.18)"/>
              <circle cx="330" cy="53" r="3.5" fill="rgba(245,158,11,0.12)"/>

              {/* Calendar expiry — x=390 */}
              <g transform="translate(390,6)" filter="url(#docShadow2)">
              ...
              <circle cx="462" cy="53" r="5" fill="rgba(239,68,68,0.18)"/>
              <circle cx="476" cy="53" r="3.5" fill="rgba(239,68,68,0.12)"/>
              ...
              <circle cx="580" cy="53" r="5" fill="rgba(99,102,241,0.18)"/>
              <circle cx="594" cy="53" r="3.5" fill="rgba(99,102,241,0.12)"/>

              {/* PDF Doc blue — x=650 */}
              <g transform="translate(650,8)" filter="url(#docShadow2)">
              ...
              <circle cx="710" cy="53" r="5" fill="rgba(59,130,246,0.18)"/>
              <circle cx="724" cy="53" r="3.5" fill="rgba(59,130,246,0.12)"/>

              {/* Shield checkmark emerald — x=780 */}
              <g transform="translate(780,3)">
