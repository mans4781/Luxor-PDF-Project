...
export default function Toolbar({
  ...
  return (
    <div className="luxor-toolbar" ref={popoverRef}>
          ...
          >
            {[
              { key: "open", label: "Open", shortcut: "Ctrl+O", icon: (
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7z"/></svg>
              ) },
              { key: "saveas", label: "Save As", shortcut: "Ctrl+Shift+S", icon: (
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/></svg>
              ) },
      ...
      <button className="toolbar-btn" onClick={onFileSaveAs} title="Save (Ctrl+Shift+S)">
        <span className="toolbar-tip">Save</span>
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      >
        ...
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
          <path d="M4 9.5V19a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-5.5"/>
          <path d="M7.5 15.5C7.8 10.6 11.2 7.6 16.4 7.3"/>
          <path d="M13.2 3.6 17.4 7.3 13.2 11"/>
        </svg>
      </button>
