    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <Card className="border-slate-200 shadow-sm">
          ...
          <CardContent className="space-y-3">
            {[
              ...
              <div key={n.label} className="flex items-center justify-between rounded-md border border-slate-100 bg-slate-50/60 px-3 py-2.5">
                <div>
          ...
          <CardContent className="space-y-3">
            <div className="rounded-md border border-slate-100 bg-slate-50/60 px-3 py-2.5">
              <div className="flex items-center justify-between">
                <div className="text-xs font-medium text-slate-700">Two-step admin login</div>
                <Badge variant="outline" className="border-emerald-200 bg-emerald-50 text-[10px] text-emerald-600">enabled</Badge>
              </div>
            ...
            <div className="rounded-md border border-slate-100 bg-slate-50/60 px-3 py-2.5">
              <div className="flex items-center justify-between">
                <div className="text-xs font-medium text-slate-700">Session token</div>
                <Badge variant="outline" className="border-slate-200 text-[10px] text-slate-400">this browser</Badge>
              </div>
              <div className="mt-0.5 text-[11px] text-slate-400">
                Your admin token is stored for this tab only and cleared when you log out.
              </div>
            </div>
            <Button variant="outline" size="sm" className="text-red-600 hover:text-red-700" onClick={onLogout}>
              Log out of console
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="border-slate-200 shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="flex items-center gap-1.5 text-sm font-semibold">
              <Globe2 className="h-4 w-4 text-slate-400" /> About this console
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-2 text-[11px] leading-relaxed text-slate-500">
            <p>
              <ShieldCheck className="mr-1 inline h-3.5 w-3.5 text-emerald-500" />
              Revenue, users, licenses, documents and traffic are <span className="font-semibold text-slate-700">live production data</span>.
            </p>
            <p>
              Sections marked <Badge variant="outline" className="mx-0.5 border-amber-200 bg-amber-50 text-[9px] text-amber-600">sample</Badge>
