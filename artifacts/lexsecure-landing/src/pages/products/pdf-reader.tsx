...
function AndroidLogo({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M17.6 11.48 19.44 8.3a.63.63 0 0 0-.23-.86.63.63 0 0 0-.86.23l-1.87 3.23a11.42 11.42 0 0 0-8.96 0L5.65 7.67a.63.63 0 0 0-.86-.23.63.63 0 0 0-.23.86l1.84 3.18C3.24 13.21 1.06 16.43.75 20.25h22.5c-.31-3.82-2.49-7.04-5.65-8.77zM7.05 17.25a1.13 1.13 0 1 1 0-2.25 1.13 1.13 0 0 1 0 2.25zm9.9 0a1.13 1.13 0 1 1 0-2.25 1.13 1.13 0 0 1 0 2.25z" />
    </svg>
  );
}
          ...
          <div className="container mx-auto px-6 max-w-[88rem]">
            ...
            <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
              ...
              <div className="rounded-3xl border-2 border-[#E50914] bg-white p-8 lg:p-10 shadow-xl relative z-10 flex flex-col md:-my-4">
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#E50914] text-white text-xs font-bold px-4 py-1.5 rounded-full tracking-wider shadow-md whitespace-nowrap">
                  OUR SOLUTION
                </div>
