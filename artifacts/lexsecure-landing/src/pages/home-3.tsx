    ...
    <div className="min-h-screen bg-white font-sans text-slate-900">
      ...
      <main className="pt-20">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-red-50/70 via-white to-rose-50/50">
          <div className="container mx-auto max-w-6xl px-6 pt-12 lg:pt-16 pb-14">
            <div className="grid lg:grid-cols-[0.95fr_1.05fr] gap-12 items-center">
              ...
              <motion.div {...fadeUp} className="relative">
                {/* AI Powered chip */}
                <div className="absolute -top-4 right-0 z-10 bg-white rounded-full shadow-lg border border-slate-100 px-3.5 py-1.5 flex items-center gap-1.5">
                  <Sparkles className="w-3.5 h-3.5 text-[#DC2626]" />
                  <span className="text-[11px] font-bold text-slate-700">AI Powered</span>
                </div>
                  ...
                  <div className="rounded-t-xl border-[8px] border-slate-800 bg-white overflow-hidden shadow-2xl">
                    <div className="aspect-[16/10] bg-slate-100 relative">
                      <div className="h-7 bg-white border-b border-slate-200 flex items-center px-3 gap-1.5">
                        ...
                        <span className="ml-3 text-[9px] font-extrabold tracking-tight text-[#DC2626]">
                          LUXOR<span className="text-slate-800">PDF</span>
                        </span>
                        <div className="ml-3 hidden sm:flex items-center gap-2.5">
                          {["View", "Annotate", "Convert", "Protect", "Sign"].map((t, i) => (
                            <span
                              key={t}
                              className={`text-[7px] font-semibold ${i === 0 ? "text-[#DC2626]" : "text-slate-500"}`}
                            >
                              {t}
                            </span>
                          ))}
                      ...
                      <div className="absolute inset-x-0 top-7 bottom-0 p-4">
                        <div className="bg-white rounded-lg shadow-md h-full p-5 flex gap-4">
                          {/* report text + chart */}
                          <div className="flex-1 min-w-0">
                            <div className="text-[15px] font-extrabold mb-1.5" style={{ color: NAVY }}>
                              Monthly Report
                            </div>
                            <p className="text-[7px] leading-[1.7] text-slate-500">
                              Document activity grew steadily this quarter as more teams moved
                              their reading, review, and approval work into LuxorPDF. Secure
                              sharing and eSigning continue to lead adoption.
                            </p>
                            {/* bar chart */}
                            <div className="mt-3 flex items-end gap-1 h-16">
                              {[35, 55, 40, 70, 52, 80, 64, 92, 75, 100].map((h, i) => (
                                <div
                                  key={i}
                                  className="flex-1 rounded-t-sm"
                                  style={{
                                    height: `${h}%`,
                                    background: i % 2 ? "#FCA5A5" : RED,
                                    opacity: 0.9,
                                  }}
                                />
                              ))}
                ...
                <motion.div
                  ...
                  className="absolute top-8 -left-2 lg:-left-5 w-12 h-12 rounded-xl bg-[#DC2626] shadow-xl flex flex-col items-center justify-center text-white"
                >
                  <FileText className="w-4 h-4" />
                  <span className="text-[8px] font-extrabold mt-0.5">PDF</span>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="absolute left-6 bottom-10 z-10"
                >
                  <div className="w-16 h-16 rounded-full bg-white shadow-xl border border-slate-100 flex items-center justify-center">
                    <div className="w-11 h-11 rounded-full bg-[#DC2626] flex flex-col items-center justify-center text-white">
                      <ShieldCheck className="w-4 h-4" />
                      <span className="text-[6px] font-extrabold tracking-wide mt-0.5">SECURE</span>
                    </div>
                  </div>
                </motion.div>
